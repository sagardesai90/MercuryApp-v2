...
public class TutorialPage2 extends TutorialPage {
    ...
    public TutorialPage2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public TutorialPage2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public TutorialPage2(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void onFinishInflate() {
        ...
        String s= "1: “Smart Mode”\n(Power Button: Green)";
        SpannableString ss1=  new SpannableString(s);
        ss1.setSpan (new CustomTypefaceSpan(custom_font), 16, 37, Spanned.SPAN_EXCLUSIVE_INCLUSIVE);
